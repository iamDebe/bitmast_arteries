      ...
      <FormWrapper>
         ...
         {signIn && <form className='form'>
            <div className='form-title'>
              ...
              <p className='type-title6 forgot'><Link  to="/forgot-password" >I forgot my password</Link></p>
          </form>
        }   
         {signUp &&<form className='form'>
            <div className='form-title'>
                <h3 className='type-title4'>Welcome Back</h3>
                <h6 className='type-title6'>Fill the form below to setup your Account</h6>
            </div>
              <InputField 
                  type="text"
                  placeholder="Hopsital/Clinic Name"
                  margin=".5rem 0rem"
                  borderradius=".2rem"
              />
              <InputField 
...
export default StaffProfileSetupForm;
