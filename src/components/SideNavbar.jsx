        ...
        <div className={`bottom-nav ${isOpen ? "close-btn-wrapper" : ""}`}>
          {isOpen ? (
            ...
            <CollapseButton onClick={onToggleCollapse}>
               <div className="icon">
               {collapsed ?   <CollapseOpen fill="" /> : <CollapseIcon  fill="" />}
              
              </div>
              {!collapsed && <span className="type-title7">Collapse</span>}
            </CollapseButton>
          )}
          <LogoutWrapper>
          <Link  to="/staff-profilesetup"><LogoutIcon fill="" /></Link>
            {!collapsed && <Link  to="/staff-profilesetup"> <p className="logout">Logout</p></Link>}
          </LogoutWrapper>
        </div>
